...
function parseAuthTransport(raw) {
    if (raw === undefined || raw.length === 0) {
...
function validateLocalBinding(host, authTransport) {
...
export function resolveDaemonConfig(env, defaults = {}) {
    ...
    return {
        adminPort: env.ASCP_ADMIN_PORT === undefined
