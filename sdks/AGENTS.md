...
7. `../services/mock-server/`
8. `../apps/reference-client/`
...
1. `../protocol/ASCP_Protocol_Detailed_Spec_v0_1.md` for exact contracts, payloads, schemas, compatibility behavior, replay rules, and error semantics
2. `../protocol/schema/`, `../protocol/spec/`, `../protocol/examples/`, and `../protocol/conformance/` for executable protocol truth and implementation-facing evidence
