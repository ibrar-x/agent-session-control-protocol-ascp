...
import messageAssistantDeltaExample from "../../../protocol/examples/events/message-assistant-delta.json";
import sessionExample from "../../../protocol/examples/core/session.json";
import sessionsListErrorExample from "../../../protocol/examples/errors/sessions-list.json";
import sessionsListResponseExample from "../../../protocol/examples/responses/sessions-list.json";
import {
  AscpValidationError,
  parseCoreEntity,
